defmodule LockScreenQRCodeWeb.Components.ToggleField do
  @moduledoc """
  LockScreenQRCodeWeb.Components.ToggleField component renders a toggle field with customizable options.
