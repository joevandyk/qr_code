defmodule LockScreenQRCodeWeb.Components.Blockquote do
  @moduledoc """
  This module provides a versatile `LockScreenQRCodeWeb.Components.Blockquote` component for creating
