defmodule LockScreenQRCodeWeb.Components.Image do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
