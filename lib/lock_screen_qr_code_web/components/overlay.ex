defmodule LockScreenQRCodeWeb.Components.Overlay do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LockScreenQRCodeWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
