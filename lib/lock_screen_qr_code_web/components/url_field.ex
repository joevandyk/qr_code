defmodule LockScreenQRCodeWeb.Components.UrlField do
  @moduledoc """
  LockScreenQRCodeWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
