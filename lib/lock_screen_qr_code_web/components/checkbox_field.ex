defmodule LockScreenQRCodeWeb.Components.CheckboxField do
  @moduledoc """
  LockScreenQRCodeWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
