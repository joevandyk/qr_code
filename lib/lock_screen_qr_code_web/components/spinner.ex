defmodule LockScreenQRCodeWeb.Components.Spinner do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LockScreenQRCodeWeb.Components.Spinner` module enables developers to provide
