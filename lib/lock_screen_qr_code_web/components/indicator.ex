defmodule LockScreenQRCodeWeb.Components.Indicator do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Indicator` module provides a versatile component for visually highlighting
