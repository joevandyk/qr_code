defmodule LockScreenQRCodeWeb.Components.Stepper do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `LockScreenQRCodeWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
