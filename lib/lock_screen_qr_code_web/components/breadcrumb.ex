defmodule LockScreenQRCodeWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `LockScreenQRCodeWeb.Components.Breadcrumb` component for displaying
