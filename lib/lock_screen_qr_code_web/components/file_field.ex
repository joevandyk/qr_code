defmodule LockScreenQRCodeWeb.Components.FileField do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LockScreenQRCodeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LockScreenQRCodeWeb.Gettext, "errors", msg, opts)
    end
  end
end
