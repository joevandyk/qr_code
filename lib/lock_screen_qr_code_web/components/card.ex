defmodule LockScreenQRCodeWeb.Components.Card do
  @moduledoc """
  Provides a set of card components for the `LockScreenQRCodeWeb.Components.Card` project. These components
