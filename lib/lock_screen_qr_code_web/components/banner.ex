defmodule LockScreenQRCodeWeb.Components.Banner do
  @moduledoc """
  LockScreenQRCodeWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
