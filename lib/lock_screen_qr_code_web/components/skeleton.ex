defmodule LockScreenQRCodeWeb.Components.Skeleton do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
