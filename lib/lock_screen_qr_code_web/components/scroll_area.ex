defmodule LockScreenQRCodeWeb.Components.ScrollArea do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
