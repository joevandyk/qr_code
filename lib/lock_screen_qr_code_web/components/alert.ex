defmodule LockScreenQRCodeWeb.Components.Alert do
  @moduledoc """
  LockScreenQRCodeWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
