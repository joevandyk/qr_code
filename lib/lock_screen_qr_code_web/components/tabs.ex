defmodule LockScreenQRCodeWeb.Components.Tabs do
  @moduledoc """
  `LockScreenQRCodeWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import LockScreenQRCodeWeb.Components.Badge, only: [badge: 1]
