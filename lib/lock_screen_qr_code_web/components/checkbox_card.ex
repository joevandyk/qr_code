defmodule LockScreenQRCodeWeb.Components.CheckboxCard do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
