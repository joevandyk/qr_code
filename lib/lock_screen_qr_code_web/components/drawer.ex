defmodule LockScreenQRCodeWeb.Components.Drawer do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Drawer` module provides a flexible and customizable drawer component
