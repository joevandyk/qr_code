defmodule LockScreenQRCodeWeb.Components.Menu do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `LockScreenQRCodeWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import LockScreenQRCodeWeb.Components.Accordion, only: [accordion: 1]
  import LockScreenQRCodeWeb.Components.Button, only: [button_link: 1]
