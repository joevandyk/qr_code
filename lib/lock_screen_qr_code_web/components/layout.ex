defmodule LockScreenQRCodeWeb.Components.Layout do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Layout` module provides powerful and customizable layout components
