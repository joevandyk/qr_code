defmodule LockScreenQRCodeWeb.Components.Rating do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
