defmodule LockScreenQRCodeWeb.Components.Clipboard do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
