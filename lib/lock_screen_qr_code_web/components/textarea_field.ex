defmodule LockScreenQRCodeWeb.Components.TextareaField do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
