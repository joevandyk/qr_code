defmodule LockScreenQRCodeWeb.Components.SpeedDial do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
