defmodule LockScreenQRCodeWeb.Components.Chat do
  @moduledoc """
  `LockScreenQRCodeWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
