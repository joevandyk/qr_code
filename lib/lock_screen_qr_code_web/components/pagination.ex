defmodule LockScreenQRCodeWeb.Components.Pagination do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Pagination` module provides a comprehensive and highly customizable
