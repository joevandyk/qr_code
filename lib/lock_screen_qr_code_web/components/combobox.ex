defmodule LockScreenQRCodeWeb.Components.Combobox do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
