defmodule LockScreenQRCodeWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `LockScreenQRCodeWeb.Components.Carousel`
  project.
