defmodule LockScreenQRCodeWeb.Components.Popover do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
