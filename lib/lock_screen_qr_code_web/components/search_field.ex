defmodule LockScreenQRCodeWeb.Components.SearchField do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.SearchField` module provides a highly customizable search input
