defmodule LockScreenQRCodeWeb.Components.Footer do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
