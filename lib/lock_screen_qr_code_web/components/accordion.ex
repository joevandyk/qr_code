defmodule LockScreenQRCodeWeb.Components.Accordion do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Accordion` module provides a flexible and customizable accordion
