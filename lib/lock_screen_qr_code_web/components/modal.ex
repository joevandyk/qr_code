defmodule LockScreenQRCodeWeb.Components.Modal do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Modal` module provides a versatile and customizable modal component for
