defmodule LockScreenQRCodeWeb.Components.Gallery do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Gallery` module provides a customizable gallery component for displaying
