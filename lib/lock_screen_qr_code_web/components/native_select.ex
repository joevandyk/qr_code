defmodule LockScreenQRCodeWeb.Components.NativeSelect do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `LockScreenQRCodeWeb.Components.NativeSelect`
