defmodule LockScreenQRCodeWeb.Components.Button do
  @moduledoc """
  Provides a comprehensive set of button components for the `LockScreenQRCodeWeb.Components.Button` project.
