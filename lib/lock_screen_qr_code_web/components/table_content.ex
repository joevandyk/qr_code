defmodule LockScreenQRCodeWeb.Components.TableContent do
  @moduledoc """
  `LockScreenQRCodeWeb.Components.TableContent` is a component module designed to create flexible and dynamic
