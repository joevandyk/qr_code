defmodule LockScreenQRCodeWeb.Components.Badge do
  @moduledoc """
  Provides customizable and flexible badge components for use in Phoenix LiveView.

  The `LockScreenQRCodeWeb.Components.Badge` module allows you to create badge elements with various styles,
