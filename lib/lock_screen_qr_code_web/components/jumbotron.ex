defmodule LockScreenQRCodeWeb.Components.Jumbotron do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Jumbotron` module provides a versatile component for creating large,
