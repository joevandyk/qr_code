defmodule LockScreenQRCodeWeb.Components.Divider do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `LockScreenQRCodeWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
