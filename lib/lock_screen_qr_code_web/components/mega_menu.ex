defmodule LockScreenQRCodeWeb.Components.MegaMenu do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
