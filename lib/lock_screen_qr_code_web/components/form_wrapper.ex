defmodule LockScreenQRCodeWeb.Components.FormWrapper do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.FormWrapper` module provides a flexible and customizable form
