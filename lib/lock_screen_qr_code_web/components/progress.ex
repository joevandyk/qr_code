defmodule LockScreenQRCodeWeb.Components.Progress do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.Progress` module provides a customizable progress bar component for
