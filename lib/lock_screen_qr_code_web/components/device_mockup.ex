defmodule LockScreenQRCodeWeb.Components.DeviceMockup do
  @moduledoc """
  The `LockScreenQRCodeWeb.Components.DeviceMockup` module provides a customizable component for displaying
