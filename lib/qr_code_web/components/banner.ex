defmodule QrCodeWeb.Components.Banner do
  @moduledoc """
  QrCodeWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
