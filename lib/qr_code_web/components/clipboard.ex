defmodule QrCodeWeb.Components.Clipboard do
  @moduledoc """
  The `QrCodeWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
