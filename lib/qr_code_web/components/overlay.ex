defmodule QrCodeWeb.Components.Overlay do
  @moduledoc """
  The `QrCodeWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `QrCodeWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
