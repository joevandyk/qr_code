defmodule QrCodeWeb.Components.Combobox do
  @moduledoc """
  The `QrCodeWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
