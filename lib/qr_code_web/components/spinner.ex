defmodule QrCodeWeb.Components.Spinner do
  @moduledoc """
  The `QrCodeWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `QrCodeWeb.Components.Spinner` module enables developers to provide
