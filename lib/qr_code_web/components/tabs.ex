defmodule QrCodeWeb.Components.Tabs do
  @moduledoc """
  `QrCodeWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import QrCodeWeb.Components.Badge, only: [badge: 1]
