defmodule QrCodeWeb.Components.Stepper do
  @moduledoc """
  The `QrCodeWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `QrCodeWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
  ...
  use Gettext, backend: QrCodeWeb.Gettext
