defmodule QrCodeWeb.Components.ScrollArea do
  @moduledoc """
  The `QrCodeWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
