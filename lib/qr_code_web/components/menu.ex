defmodule QrCodeWeb.Components.Menu do
  @moduledoc """
  The `QrCodeWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `QrCodeWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import QrCodeWeb.Components.Accordion, only: [accordion: 1]
  import QrCodeWeb.Components.Button, only: [button_link: 1]
