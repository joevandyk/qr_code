defmodule QrCodeWeb.Components.Alert do
  @moduledoc """
  QrCodeWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
