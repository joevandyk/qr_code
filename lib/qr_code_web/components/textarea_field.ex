defmodule QrCodeWeb.Components.TextareaField do
  @moduledoc """
  The `QrCodeWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
