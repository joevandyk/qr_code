defmodule QrCodeWeb.Components.NativeSelect do
  @moduledoc """
  The `QrCodeWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `QrCodeWeb.Components.NativeSelect`
