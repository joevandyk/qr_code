defmodule QrCodeWeb.Components.CheckboxCard do
  @moduledoc """
  The `QrCodeWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
