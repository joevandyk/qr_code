defmodule QrCodeWeb.Components.FileField do
  @moduledoc """
  The `QrCodeWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import QrCodeWeb.Components.Progress, only: [progress: 1]
