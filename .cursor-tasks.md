...
- [ ] **URL Input:** Create functional form with URL field and optional display name field, referencing the mockup's layout.
- [ ] **Validation:** Implement URL validation on form submission with LiveView feedback.
- [ ] **Error Handling:** Display clear error messages for invalid URLs following the mockup's visual style.
- [ ] **Continue & Back:** Implement navigation buttons with correct ordering (back left, continue right) and LiveView events.
- [ ] **Responsive Design:** Ensure form works correctly on both mobile and desktop layouts as shown in mockups.
- [ ] **Tests:** Add form submission tests including validation.
